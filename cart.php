...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart | Michael Ebook Shop</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['username'])) {
            echo '<a href="orders-update.php"><button style="float:right;">PRODUCT ORDERS</button></a>';
          }
    ...
    <div class="row" style="margin-top:10px; background-color:#FC3">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">Copyright &copy; 2015 Michael's Ebook Shop. All Rights Reserved.</p>
        </footer>
